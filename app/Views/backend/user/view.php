                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="password" name="repassword" class="form-control repassword" placeholder="Ulangi Password" required>
                                            ...
                                            <form action="<?= base_url('user/edit'); ?>" method="post" class="edit">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <label class="text-primary">Password</label>
                                                            <input type="password" name="password" class="form-control password" value="<?= $item['password'] ?>" required>
                                                            <div class="invalid-feedback errorPassword"></div>
                                                            <br>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <label class="text-primary">Ulangi Password</label>
                                                            <input type="password" name="repassword" class="form-control repassword" value="<?= $item['password'] ?>" required>
                                                            <div class="invalid-feedback errorRepassword"></div>
                                                            <br>
                                                        </div>
                                                    </div>
