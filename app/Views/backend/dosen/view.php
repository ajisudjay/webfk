                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" name="bidang" class="form-control bidang" placeholder="Bidang" required>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select name="prodi" class="form-control">
                                        ...
                                        <?php foreach ($prodi as $item_prodi) : ?>
                                            <option value="<?= $item_prodi['id'] ?>"><?= $item_prodi['prodi'] ?></option>
                                        <?php endforeach ?>
                                    </select>
                                    <div class="invalid-feedback errorBidang"></div>
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <textarea name="pendidikan" id="pendidikan" cols="30" rows="10" required></textarea>
                                    <div class="invalid-feedback errorPendidikan"></div>
                                </div>
                                <div class="col-lg-12">
                                    <label class="text-primary">Akun</label>
                                    <textarea name="akun" id="akun" cols="30" rows="10" required></textarea>
                    ...
                    <?php foreach ($dosen as $item) : ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <button type="button" class="btn-sm btn-primary border-0" data-toggle="modal" data-target="#editmodal<?= $id = $item['dosen_id'] ?>">
                                    <span class="feather icon-edit-1 text-default"></span>
                                </button>
                                <!-- edit modal-->
                                <div class="modal fade" id="editmodal<?= $id = $item['dosen_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <form action="<?= base_url('dosen/edit'); ?>" enctype="multipart/form-data" method="post" class="edit">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <label class="text-primary">NIP</label>
                                                                <input type="text" name="id" class="form-control id" value="<?= $item['dosen_id'] ?>" hidden>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <label class="text-primary">Bidang</label>
                                                                <input type="text" name="bidang" class="form-control bidang" value="<?= $item['bidang'] ?>" required>
                                                                <div class="invalid-feedback errorBidang"></div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <label class="text-primary">Foto</label>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <label class="text-primary">Program Studi</label>
                                                                <select name="prodi" class="form-control">
                                                                    <option value="<?= $item['id_ps'] ?>"><?= $item['prodi'] ?></option>
                                                                    <?php foreach ($prodi as $item_prodi) : ?>
                                                                        <option value="<?= $item_prodi['id'] ?>"><?= $item_prodi['prodi'] ?></option>
                                                                    <?php endforeach ?>
                                                                </select>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <label class="text-primary">Pendidikan</label>
                                                                <?php $pendidikanx = 'pendidikan' . $item['id']; ?>
                                                                <textarea name="pendidikan" id="<?= $pendidikanx ?>" cols="30" rows="10" required><?= $item['pendidikan'] ?></textarea>
                                                                <div class="invalid-feedback errorPendidikan"></div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <label class="text-primary">Akun</label>
                                                                <?php $akunx = 'akun' . $item['id']; ?>
                                                                <textarea name="akun" id="<?= $akunx ?>" cols="30" rows="10" required><?= $item['akun'] ?></textarea>
                                                                <div class="invalid-feedback errorAkun"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <!-- button hapus modal-->
                                <a href="<?= base_url('dosen/hapus/' . $item['dosen_id']); ?>" class="hapus">
